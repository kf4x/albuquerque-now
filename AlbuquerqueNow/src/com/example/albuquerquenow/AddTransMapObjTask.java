...
public class AddTransMapObjTask extends AsyncTask<String, Void, List<Object>>{
    private JSONObject json;
    private JSONArray marks;
    private Activity activity;
    private OnCompleteCB callback;
    
    public AddTransMapObjTask(Activity a) {
		// TODO Auto-generated constructor stub
    	activity = a;
	}
    public AddTransMapObjTask(Activity a, OnCompleteCB c) {
		// TODO Auto-generated constructor stub
    	activity = a;
    	callback = c;
	}   
