...
import com.example.albuquerquenow.util.SystemUiHider;
...
public class LegalNoticesActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TextView f = (TextView) contentView;
		f.setText(GooglePlayServicesUtil.getOpenSourceSoftwareLicenseInfo(this));
